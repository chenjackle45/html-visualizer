...
> **本機複本註記：**字型堆疊、Google Fonts、profile／onboarding、7／9px 字階在本機 html-visualizer 語境不採用，顏色一律換成 html-visualizer token（對照表見 `html-visualizer skill 目錄的 references/structure-diagrams.md`）；版面規則照用。
